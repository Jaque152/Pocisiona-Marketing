...
export function Footer() {
  ...
  // Función estricta para cambiar el idioma manteniendo la ruta actual
            ...
            <div className="flex gap-4">
              {["instagram", "twitter", "linkedin", "facebook"].map((social) => (
                <a
                  key={social}
                  href={`#${social}`}
                  className="w-10 h-10 rounded-xl bg-[var(--charcoal)] flex items-center justify-center text-[var(--cream)]/50 hover:text-[var(--amber)] hover:bg-[var(--charcoal)]/80 transition-all duration-300"
                >
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-6 order-1 md:order-2">
              ...
              <div className="flex items-center gap-2 bg-[var(--charcoal)]/50 p-1 rounded-lg border border-[var(--copper)]/20">
                <Globe className="w-4 h-4 text-[var(--cream)]/50 ml-2" />
                <button
...
function SocialIcon({ name }: { name: string }) {
  // ... (El objeto de iconos se mantiene exactamente igual que el tuyo)
